...
import com.hixtrik.purenews.databinding.FragmentBigNewsBinding

private const val ARG_newsTitle = "newsTitle"
private const val ARG_newsImage = "newsImage"

class BigNewsFragment : Fragment() {
    private lateinit var binding: FragmentBigNewsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBigNewsBinding.inflate(inflater)
